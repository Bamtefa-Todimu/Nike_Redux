        ...
        <div className="footer-wrapper">
            ...
            <div className="footer-end">
                <div className="fe-left">
                    <p><svg height="15px" width="18px" fill="#ffffff" viewBox="0 0 42 58"><path d="M21 0C9.4 0 0 9.5 0 21.2 0 39.9 21 58 21 58s21-18.1 21-36.8C42 9.5 32.6 0 21 0zm0 31c-5.5 0-10-4.5-10-10s4.5-10 10-10 10 4.5 10 10-4.5 10-10 10z"></path></svg>
                        &nbsp; &nbsp;  United States &nbsp; &nbsp; <span className="rights">© 2022 Nike, Inc. All Rights Reserved</span>
                    </p>
                </div>

                <div className="fe-right">
                    <ul className="fer-misc">
                        <li>Guides</li>
                        <li>Terms of Sale</li>
                        <li>Terms of Use</li>
